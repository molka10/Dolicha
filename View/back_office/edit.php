        ...
        <form action="" method="POST" name="myForm" onsubmit="return validateForm()">
            ...
            <div class="form-group">
                ...
                <select name="category_name" id="category_name" class="form-control" required>
                    ...
                    <option value="Man" <?= ($category->getCategoryName() == 'Man') ? 'selected' : '' ?>>Man</option>
                    <option value="Woman" <?= ($category->getCategoryName() == 'Woman') ? 'selected' : '' ?>>Woman</option>
                    <option value="Accessory" <?= ($category->getCategoryName() == 'Accessory') ? 'selected' : '' ?>>Accessory</option>
                </select>
            </div>
