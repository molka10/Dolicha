<?php
session_start();
require_once 'C:\xampp\htdocs\dolicha0.2\controllers\userController.php'; // Inclure le contrôleur d'utilisateur
require_once 'C:\xampp\htdocs\dolicha0.2\config.php'; // Inclure la connexion à la base de données
...
$user = getUserById($user_id); // Récupérer les informations de l'utilisateur par ID
...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['action']) && $_POST['action'] == 'edit') {
    ...
    if (!filter_var($usermail, FILTER_VALIDATE_EMAIL)) {
        ...
        if (updateUser($user_id, $nom, $prenom, $usermail, $adress, $Nationalite, $ddn, $num)) {
