<?php
require_once 'C:\xampp\htdocs\dolicha0.2\config.php'; // Include Database class
require_once 'C:\xampp\htdocs\dolicha0.2\controllers\userController.php'; // Include user controller functions
    ...
    <header id="header">
        ...
        <div class="container main-menu">
            <div class="row align-items-center justify-content-between d-flex">
                <div id="logo">
                    <a href="index.php"><img src="../front_office/img/lo.png" alt="" title="" style="width: 200px; height: 100px;" /></a>
                </div>
                <nav id="nav-menu-container">
                    <ul class="nav-menu">
                        ...
                        <li><a href="indexp.php"><i class="fa fa-shopping-cart"></i>Product</a></li>
