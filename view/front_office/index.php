                    ...
                    <ul class="nav-menu">
						...
						<?php
							if (isset($_SESSION['user'])){
								?><a href="profil.php">Hello, <?php echo htmlspecialchars($nom); ?>!</a> <?php
								echo '<a href="logout.php" class="btn btn-danger" style="color: white;">Logout</a>';
							}else{
								echo '<a href="login.html" class="btn btn-primary" style="color: white;">Login</a>';
								echo '<a href="signup.php" class="btn btn-primary" style="color: white;">Sign Up</a>';
							}
						?>
                        <li> </li>
