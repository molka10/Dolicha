<?php
require_once 'C:\xampp\htdocs\dolicha0.2\config.php'; // Include database configuration
require_once 'C:\xampp\htdocs\dolicha0.2\controllers\userController.php'; // Include UserController
...
if (isset($_GET['id_user'])) {
    $id_user = intval($_GET['id_user']); // Ensure the ID is an integer
    $user = $userController->getUserById($id_user); // Use the UserController to get user by ID
    if (!$user) {
            ...
            <div class="col-md-6 grid-margin stretch-card">
              <div class="card">
                  <div class="card-body">
                      ...
                      <?php if ($user): ?>
                          <form class="forms-sample" method="POST" action="../../../../controllers/userController.php">
                              <!-- Hidden Fields -->
                              ...
                              <button type="reset" class="btn btn-light" href="index.php">Annuler</button>
                          </form>
                      <?php else: ?>
